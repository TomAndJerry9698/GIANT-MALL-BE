...
public class ProductController {
    ...
    @PostMapping
    public ApiResponseDto<ProductResponseDto> createProduct(@RequestBody @Valid ProductCreateDto dto) {
    ...
    @PutMapping("/{id}")
    public ApiResponseDto<ProductResponseDto> updateProduct(@PathVariable Long id, @RequestBody @Valid ProductCreateDto dto) {
