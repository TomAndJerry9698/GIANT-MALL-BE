...
VALUES
('유기농 사과',        '신선한 국내산 유기농 사과입니다.',             12000.00, 2, NOW(), NULL),
('블루투스 스피커',    '고출력 무선 블루투스 스피커.',                 55000.00, 2, NOW(), NULL),
('초코쿠키 10개입',    '수제 초콜릿 쿠키 세트.',                       8000.00, 2, NOW(), NULL),
('노트북 거치대',      '알루미늄 재질 각도조절 노트북 거치대.',         25000.00, 2, NOW(), NULL),
